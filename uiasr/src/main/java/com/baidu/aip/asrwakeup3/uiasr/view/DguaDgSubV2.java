...
public class DguaDgSubV2 extends ViewGroup {
    public int index = 0;
    private String str;
    private TextView tva;

    public DguaDgSubV2(Context context) {
        super(context);
    ...
    public DguaDgSubV2(Context context, AttributeSet attributeSet) {
    ...
    public DguaDgSubV2(Context context, AttributeSet attributeSet, int i) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            int i6 = (((ActivityCommon.SCREENWIDTH * 7) / 10) - width) / 2;
            i6 = ((ActivityCommon.SCREENHEIGHT / 10) - height) / 2;
            childAt.layout(0, i6, (width + 0) + 50, (height + i6) + 50);
        }
    }

    @Override
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(MeasureSpec.getSize((ActivityCommon.SCREENWIDTH * 7) / 10), MeasureSpec.getSize(ActivityCommon.SCREENHEIGHT / 10));
    }
}
