package com.baidu.aip.asrwakeup3.uiasr.call.commn;
...
public class CircleProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(progress + "->tell", centerX - (mTextPaint.measureText(progress + "->tell")) / 2, centerY + textsize / 2, mTextPaint);
    }
