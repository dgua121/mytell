...
public class DguaMishibutton extends ViewGroup implements OnTouchListener {
    public int index = 0;
    private String str;
    ...
    public DguaMishibutton(Context context) {
        super(context);
    ...
    public DguaMishibutton(Context context, AttributeSet attributeSet) {
    ...
    public DguaMishibutton(Context context, AttributeSet attributeSet, int i) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            int height = ((rect.bottom + rect.height()) * ActivityCommon.densityDpi) / 135;
            int width = ((rect.width() + rect.left) * ActivityCommon.densityDpi) / 155;
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(MeasureSpec.getSize(ActivityCommon.SCREENWIDTH / 5), MeasureSpec.getSize(ActivityCommon.SCREENHEIGHT / 10));
    }
}
