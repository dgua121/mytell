...
public class DguaCtSubV2 extends ViewGroup {
    public int index = 0;
    private String str;
    private TextView tva;

    public DguaCtSubV2(Context context) {
        super(context);
    ...
    public DguaCtSubV2(Context context, AttributeSet attributeSet) {
    ...
    public DguaCtSubV2(Context context, AttributeSet attributeSet, int i) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            int i6 = (((ActivityCommon.SCREENWIDTH * 2) / 5) - width) / 2;
